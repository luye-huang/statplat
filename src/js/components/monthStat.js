            ...
            <div>
                ...
                <Row gutter={16} style={{ marginBottom: 16 }}>
                    <Col span={6} className="exam-result">
                        <span>一级部门</span>
                        <div>
                            <Dropdown overlay={dropMenu1} trigger={["click"]}>
                    ...
                    <Col span={6}>
                        <Input addonBefore="二级部门" defaultValue={this.state.dep1_id} name="dep2_id"
                               onChange={this.handleChange.bind(this)}/>
                    </Col>
                    <Col span={6}>
                        <Input addonBefore="三级部门" defaultValue={this.state.dep1_id} name="dep3_id"
                               onChange={this.handleChange.bind(this)}/>
                    </Col>
