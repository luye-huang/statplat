      ...
      <div>
            ...
            <Col span={18}>
              ...
              <Row>
                ...
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="tl_num_1" value={this.state.tl_num_1} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="tl_num_2" value={this.state.tl_num_2} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="tl_num_3" value={this.state.tl_num_3} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="tl_num_4" value={this.state.tl_num_4} onChange={this.handleChange.bind(this)}/></Col>
              ...
              <Row>
                ...
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.pass_rate_color}} type="number"
                  placeholder="" name="tl_rate_1" value={this.state.tl_rate_1} onChange={this.handleChange.bind(this)}/></Col>
                ...
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.test_norunrate_color }} type="number"
          ...
          <Row>
            ...
            <Col span={18}>
              ...
              <Row>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><span>数量</span></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_num_1" value={this.state.jira_num_1} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_num_2" value={this.state.jira_num_2} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_num_3" value={this.state.jira_num_3} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_num_4" value={this.state.jira_num_4} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-bottom-css"><Input type="number"
              ...
              <Row>
                ...
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_close_num_1" value={this.state.jira_close_num_1} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_close_num_2" value={this.state.jira_close_num_2} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_close_num_3" value={this.state.jira_close_num_3} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css border-bottom-css"><Input type="number"
                  placeholder="*填入数量" name="jira_close_num_4" value={this.state.jira_close_num_4} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-bottom-css"><Input type="number"
              ...
              <Row>
                ...
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.b_repairrate_color }} type="number"
                  placeholder="" name="jira_repair_rate_1" value={this.state.jira_repair_rate_1} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.c_repairrate_color }} type="number"
                  placeholder="" name="jira_repair_rate_2" value={this.state.jira_repair_rate_2} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.major_repairrate_color }} type="number"
                  placeholder="" name="jira_repair_rate_3" value={this.state.jira_repair_rate_3} onChange={this.handleChange.bind(this)}/></Col>
                <Col span={4} className="test-result-detail border-right-css"><Input style={{ backgroundColor: this.state.minor_repairrate_color }} type="number"
        ...
        <div>
          ...
          <Row>
            ...
            <Col span={9} style={{ backgroundColor: (this.state.dropData_service=="已上线"?"green":(this.state.dropData_service=="未上线"?"yellow":"")) }}
          ...
          <Row>
            ...
            <Col span={9} style={{ backgroundColor: (this.state.dropData_merge=="无变更"?"green":(this.state.dropData_merge=="有变更"?"red":"")) }}
                 className="test-result-detail dropdown-list-css border-right-css border-bottom-css">
              <div>
  ...
  componentDidMount() {
    ...
    api.getMergeReport_Jira(work_id).then(data=> {
      ...
      if(colorConfigData!=undefined){
        ...
        if(this.state.jira_num_3==0 && this.state.jira_close_num_3==0) {
          ...
          major_repairrate_color = this.state.jira_repair_rate_3==colorConfigData.mm_repaire_rate.blue[1]/100?"blue":
            ( (this.state.jira_repair_rate_3>colorConfigData.mm_repaire_rate.green[0]/100 || this.state.jira_repair_rate_3==colorConfigData.mm_repaire_rate.green[0]/100)?"green":
        ...
        if(this.state.jira_num_4==0 && this.state.jira_close_num_4==0) {
          ...
          minor_repairrate_color = this.state.jira_repair_rate_4==colorConfigData.mm_repaire_rate.blue[1]/100?"blue":
            ( (this.state.jira_repair_rate_4>colorConfigData.mm_repaire_rate.green[0]/100 || this.state.jira_repair_rate_4==colorConfigData.mm_repaire_rate.green[0]/100)?"green":
      ...
      this.setState({
        ...
        dropData_service:(serviceSta == 0)?"未上线":(serviceSta == 1?"已上线":"已上线") ,
        dropData_merge:(mergeSta == 0)?"无变更":(mergeSta == 1?"有变更":"无变更") ,
